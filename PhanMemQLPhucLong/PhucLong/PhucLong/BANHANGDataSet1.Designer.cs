...
namespace PhucLong {
    ...
    public partial class BANHANGDataSet1 : global::System.Data.DataSet {
        ...
        public partial class HOADONDataTable : global::System.Data.TypedTableBase<HOADONRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public HOADONRow AddHOADONRow(string SoHD, System.DateTime NgaylapHD, string MaKH) {
...
namespace PhucLong.BANHANGDataSet1TableAdapters {
    ...
    public partial class HOADONTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[HOADON] WHERE (([SoHD] = @Original_SoHD) AND ((@IsNull_Ngaylap" +
                "HD = 1 AND [NgaylapHD] IS NULL) OR ([NgaylapHD] = @Original_NgaylapHD)) AND ((@I" +
                "sNull_MaKH = 1 AND [MaKH] IS NULL) OR ([MaKH] = @Original_MaKH)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[HOADON] ([SoHD], [NgaylapHD], [MaKH]) VALUES (@SoHD, @NgaylapH" +
                "D, @MaKH);\r\nSELECT SoHD, NgaylapHD, MaKH FROM HOADON WHERE (SoHD = @SoHD)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[HOADON] SET [SoHD] = @SoHD, [NgaylapHD] = @NgaylapHD, [MaKH] = @MaKH WHERE (([SoHD] = @Original_SoHD) AND ((@IsNull_NgaylapHD = 1 AND [NgaylapHD] IS NULL) OR ([NgaylapHD] = @Original_NgaylapHD)) AND ((@IsNull_MaKH = 1 AND [MaKH] IS NULL) OR ([MaKH] = @Original_MaKH)));
SELECT SoHD, NgaylapHD, MaKH FROM HOADON WHERE (SoHD = @SoHD)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SoHD, NgaylapHD, MaKH FROM dbo.HOADON";
        ...
        public virtual int Delete(string Original_SoHD, global::System.Nullable<global::System.DateTime> Original_NgaylapHD, string Original_MaKH) {
        ...
        public virtual int Insert(string SoHD, global::System.Nullable<global::System.DateTime> NgaylapHD, string MaKH) {
            if ((SoHD == null)) {
        ...
        public virtual int Update(string SoHD, global::System.Nullable<global::System.DateTime> NgaylapHD, string MaKH, string Original_SoHD, global::System.Nullable<global::System.DateTime> Original_NgaylapHD, string Original_MaKH) {
            if ((SoHD == null)) {
                throw new global::System.ArgumentNullException("SoHD");
            }
            else {
            ...
            if ((Original_NgaylapHD.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(Original_NgaylapHD.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<global::System.DateTime> NgaylapHD, string MaKH, string Original_SoHD, global::System.Nullable<global::System.DateTime> Original_NgaylapHD, string Original_MaKH) {
            return this.Update(Original_SoHD, NgaylapHD, MaKH, Original_SoHD, Original_NgaylapHD, Original_MaKH);
        }
    }
